...
export default function CustomizedTables({rows, headNames, handleDelete, handleEdit}) {
  ...
  {rows.map((row, index) => (
    <StyledTableRow key={index}>
      ...
      <StyledTableCell align="center" className='font-light'>{index+1}</StyledTableCell>
      <StyledTableCell align="start" className='font-light'>{row[Object.keys(row)[1]]}</StyledTableCell>
      <StyledTableCell align="center" className='font-light'>{row[Object.keys(row)[2]]}</StyledTableCell>
